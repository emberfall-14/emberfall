...
public sealed class EngravableSystem : SharedEngravableSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EngravableComponent, GetVerbsEvent<ActivationVerb>>(AddEngraveVerb);
    }

    private void AddEngraveVerb(Entity<EngravableComponent> ent, ref GetVerbsEvent<ActivationVerb> args)
    {
            ...
            Act = () =>
            {
                _dialog.OpenDialog(actor.PlayerSession,
                    ...
                    (string message) =>
                    {
                        ...
                        if (actor.PlayerSession.AttachedEntity == null || !HasComp<EngravableComponent>(ent))
                            return;
