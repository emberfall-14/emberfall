...
bounty-description-artifact = Solus Concord is in some hot water for stealing artifacts from non-spacefaring planets. Return one and we'll compensate you for it.
...
bounty-description-knife = One of our top commanders recently won a brand new set of knives on an official Solus Concord gameshow. Unfortunately, we don't have a set on hand. Send us a bunch of sharp things so we can throw something together.
...
bounty-description-pancake = Here at Solus Concord we consider employees to be family. And you know what families love? Pancakes. Ship a baker's dozen.
...
bounty-description-soup = To quell the homeless uprising, Solus Concord will be serving soup to all underpaid workers. Ship any type of soup.
...
bounty-description-syringe = The SC anti-drug task force is in need of some syringes in order to distribute them to low-income communities. Help some keep some peoples' jobs secure.
